...
perl_string_to_python = pperl_string_to_python
dict_to_perl_string = pdict_to_perl_string
list_to_perl_string = plist_to_perl_string
escape_perl_string = pescape_perl_string
